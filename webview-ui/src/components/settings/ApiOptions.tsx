...
import { ClaudeSubscriptionDirectSdkProvider } from "./providers/ClaudeSubscriptionDirectSdkProvider"
...
const ApiOptions = ({ showModelOptions, apiErrorMessage, modelIdErrorMessage, isPopup, currentMode }: ApiOptionsProps) => {
	...
	return (
		<div style={{ display: "flex", flexDirection: "column", gap: 5, marginBottom: isPopup ? -10 : 0 }}>
			...
			{apiConfiguration && selectedProvider === "claude-subscription-directsdk-experimental" && (
				<ClaudeSubscriptionDirectSdkProvider
